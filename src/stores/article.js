...
export const useArticleStore = defineStore('article', () => {
    ...
    async function fecthArticles({search = "", sortDir= 'desc' , sortBy = 'createdAt'} = {}) {
    ...
    async function fecthOwnArticle(page , perpage) {
        try {
            let res = await api.get(`/articles/own/?search=&_page=${page}&_per_page=${perpage}&sortBy=createdAt&sortDir=desc`)
