...
let perPage = ref(10)
onMounted(async () => {
  categoryStore.fecthCategory(1, perPage.value)
})
let columns = [
  {
    label: 'Name', key: 'name'
...
function handleNextPage(page) {
  categoryStore.fecthCategory(page, perPage.value)
}
...
async function handleCreateCategory(){
  ...
  try{
    ...
    await categoryStore.fecthCategory(categoryStore.pagination.currentPage,perPage.value)
    handleCloseModal()
  }
  catch(err){
