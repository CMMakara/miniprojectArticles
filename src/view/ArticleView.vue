<template>
  ...
  <div class="d-flex">
    ...
    <div class=" flex-grow-1 content p-4"">
      ...
      <BaseTable :columns="columns" :rows="articleStore.ownArticle" @deleteArticle="handleDelete"
...
async function handleDelete(id) {
  ...
  await articleStore.fecthOwnArticle(articleStore.pagination.currentPage , perPage.value);
}
